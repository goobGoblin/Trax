...
\section{Design}
    ...
    \begin{itemize}
        \item query
				/\includegraphics[width=\linewidth]{Queries/1.png}
				\includegraphics[width=\linewidth]{Queries/2.png}
				\includegraphics[width=\linewidth]{Queries/3.png}
				\includegraphics[width=\linewidth]{Queries/4.png}
				\includegraphics[width=\linewidth]{Queries/5.png}
				\includegraphics[width=\linewidth]{Queries/6.png}
				\includegraphics[width=\linewidth]{Queries/7.png}
				\includegraphics[width=\linewidth]{Queries/8.png}
    \end{itemize}
